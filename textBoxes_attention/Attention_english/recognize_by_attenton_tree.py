...
sys.path.insert(0, '/opt/yushan/TextBoxes/examples/TextBoxes')
	
from Attention.model.model import Model
import Attention.model._trietree as trieTree
...
with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess: 
	...
	model_def = '/opt/yushan/TextBoxes/examples/TextBoxes/deploy.prototxt'
	model_weights = '/opt/yushan/TextBoxes/models/VGGNet/text/longer_conv_300x300/VGG_text_longer_conv_300x300_iter_150000.caffemodel'

	#horizontal proposal and vertical proposal
	model_def = '/opt/yushan/TextBoxes/jobs1/deploy.prototxt'
	model_weights = '/opt/yushan/TextBoxes/jobs1/VGG_text_longer_conv_300x300_iter_260000.caffemodel'

	#vertical proposal
	#model_def = '/opt/yushan/TextBoxes/jobs2/deploy.prototxt'
	#model_weights = '/opt/yushan/TextBoxes/jobs2/VGG_text_longer_conv_300x300_iter_190000.caffemodel'
	...
	save_dir='/opt/yushan/TextBoxes/examples/TextBoxes/test_bb/'
	orig_image_dir = '/opt/yushan/TextBoxes/examples/TextBoxes/test'
	#加载字典
	trieTree.trie = trieTree.construction_trietree("/opt/yushan/TextBoxes/examples/TextBoxes/lexicon1.txt")
	...
	for line in files:
		...
		if len(nmsIndex)>0:
			...
			for i in xrange(total_boxes.shape[0]):
				...
				'''if trieTree.trie is not None:                         
					word = trieTree.correct_word(str1, 1, trieTree.trie) '''
		...
		cv2.imwrite('/opt/yushan/TextBoxes/examples/TextBoxes/test_vi/'+line,saveimge)	  
