...
class ExpConfig:
    ...
    NUM_EPOCH = 1000
    BATCH_SIZE = 128
    INITIAL_LEARNING_RATE = 0.1 # initial learning rate, note the we use AdaDelta, so the initial value doe not matter much
    ...
    ATTN_NUM_LAYERS = 1 # number of layers in attention decoder cell
