...
class CNN(object):
    ...
    def _build_network(self, input_tensor, is_training):
        ...
        print('CNN input: {}'.format(net.get_shape()))
        ...
        print('CNN 4: {}'.format(net.get_shape()))

        net = ConvReluBN(net, 512, (2, 2), 'conv_conv7', is_training, "VALID") #注意：VALID不填充，所以特征图的宽和高要减1
        print('CNN 5: {}'.format(net.get_shape()))
        net = dropout(net, is_training)
        print('CNN 6: {}'.format(net.get_shape()))
