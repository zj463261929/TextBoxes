...
class Seq2SeqModel(object):
    ...
    def __init__(self, encoder_masks, encoder_inputs_tensor, 
        ...
        #attn_num_hidden=256
        #print("decode attn_num_hidden:{}".format(attn_num_hidden))
        ...
        #attn_num_layers = 3
        #print("decoder layer is {}".format(attn_num_layers))
        ...
        def seq2seq_f(lstm_inputs, decoder_inputs, seq_length, do_decode):
            ...
            #num_hidden = 256
            #print("encode attn_num_hidden:{}".format(num_hidden))
            
            '''lstm_fw_cell_0 = tf.contrib.rnn.core_rnn_cell.BasicLSTMCell(num_hidden, forget_bias=0.0, state_is_tuple=False)
            lstm_fw_cell = tf.contrib.rnn.core_rnn_cell.MultiRNNCell([lstm_fw_cell_0] * 2, state_is_tuple=False)            
            
            # Backward direction cell
            lstm_bw_cell_0 = tf.contrib.rnn.core_rnn_cell.BasicLSTMCell(num_hidden, forget_bias=0.0, state_is_tuple=False)
            lstm_bw_cell = tf.contrib.rnn.core_rnn_cell.MultiRNNCell([lstm_bw_cell_0] * 2, state_is_tuple=False)'''
            ...
            #print("pre_encoder_inputs lenght is {}".format(len(pre_encoder_inputs)))
            #print("pre_encoder_inputs[0] is {}".format(pre_encoder_inputs[0].get_shape()))
            #print("output_state_fw is {}".format(output_state_fw.get_shape()))
